...
\begin{body}
	\vspace{14pt}
Entry-Level C\# Developer Position at Lokion
\end{body}
...
\begin{body}
	\vspace{14pt}
	\textbf{B.S. Mathematics Honors --- Cum Laude} \hfill \emph{December 2012} \\
	\emph{The University of Tennessee at Knoxville}, Knoxville, TN\\
\end{body}
	\begin{comment}
	\\
	\textbf{Coursework includes:} Honors Introductory Physics (2 semesters), Modern Physics, Mathematical Physics, Data Structures, Computer Organization, Scientific Computing, Honors Analysis, Honors Algebra, Graph Theory, Partial Differential Equations, Probability \& Statistics, Number Theory, and Combinatorics.
	\end{comment}
\smallskip
...
\begin{body}
	...
	\textbf{Graduate Assistant}, \emph{Institute for Intelligent Systems} \hfill \emph{September 2014 - Present}\\
	\vspace*{-4pt}
